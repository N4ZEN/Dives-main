        ...
        <View style={{ flex: 1, backgroundColor: COLORS.lightGray2, padding: 10 }}>
            <View style={styles.optionsWrapper}>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: 45, }}>
                    ...
                    >
                        {editprofile? 
                        <Feather name='check' size={30} color={colour.white} />
                ...
                <View >
                    <Text style={styles.subHeader}>{!userData ? "" : userData.data.email}</Text>
                    <View style ={{flexDirection: 'row', justifyContent: 'center'}}>
                        ...
                        />
                        {editprofile? 
                            <TouchableOpacity onPress={() => seteditprofile(false)} style={{paddingVertical: 12,}}>
                                <Feather name='x' size={30} color={colour.white}  style={{alignSelf: 'center'}}/>
                            </TouchableOpacity>
                            : null
                        }
